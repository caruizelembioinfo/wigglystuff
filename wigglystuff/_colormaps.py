"""Pre-computed 256-entry colormap LUTs as hex strings. No runtime dependencies."""
...
COLORMAPS: dict[str, list[str]] = {
    ...
    "greys": [
        "#ffffff", "#fefefe", "#fefefe", "#fdfdfd", "#fdfdfd", "#fcfcfc", "#fcfcfc", "#fbfbfb",
        "#fbfbfb", "#fafafa", "#fafafa", "#f9f9f9", "#f9f9f9", "#f8f8f8", "#f8f8f8", "#f7f7f7",
        "#f7f7f7", "#f7f7f7", "#f6f6f6", "#f6f6f6", "#f5f5f5", "#f5f5f5", "#f4f4f4", "#f4f4f4",
        "#f3f3f3", "#f3f3f3", "#f2f2f2", "#f2f2f2", "#f1f1f1", "#f1f1f1", "#f0f0f0", "#f0f0f0",
        "#efefef", "#efefef", "#eeeeee", "#ededed", "#ededed", "#ececec", "#ebebeb", "#eaeaea",
        "#eaeaea", "#e9e9e9", "#e8e8e8", "#e7e7e7", "#e7e7e7", "#e6e6e6", "#e5e5e5", "#e5e5e5",
        "#e4e4e4", "#e3e3e3", "#e2e2e2", "#e2e2e2", "#e1e1e1", "#e0e0e0", "#e0e0e0", "#dfdfdf",
        "#dedede", "#dddddd", "#dddddd", "#dcdcdc", "#dbdbdb", "#dadada", "#dadada", "#d9d9d9",
        "#d8d8d8", "#d7d7d7", "#d7d7d7", "#d6d6d6", "#d5d5d5", "#d4d4d4", "#d3d3d3", "#d2d2d2",
        "#d1d1d1", "#d0d0d0", "#cfcfcf", "#cfcfcf", "#cecece", "#cdcdcd", "#cccccc", "#cbcbcb",
        "#cacaca", "#c9c9c9", "#c8c8c8", "#c8c8c8", "#c7c7c7", "#c6c6c6", "#c5c5c5", "#c4c4c4",
        "#c3c3c3", "#c2c2c2", "#c1c1c1", "#c1c1c1", "#c0c0c0", "#bfbfbf", "#bebebe", "#bdbdbd",
        "#bcbcbc", "#bbbbbb", "#bababa", "#b8b8b8", "#b7b7b7", "#b6b6b6", "#b5b5b5", "#b3b3b3",
        "#b2b2b2", "#b1b1b1", "#b0b0b0", "#afafaf", "#adadad", "#acacac", "#ababab", "#aaaaaa",
        "#a8a8a8", "#a7a7a7", "#a6a6a6", "#a5a5a5", "#a4a4a4", "#a2a2a2", "#a1a1a1", "#a0a0a0",
        "#9f9f9f", "#9d9d9d", "#9c9c9c", "#9b9b9b", "#9a9a9a", "#999999", "#979797", "#969696",
        "#959595", "#949494", "#939393", "#929292", "#919191", "#8f8f8f", "#8e8e8e", "#8d8d8d",
        "#8c8c8c", "#8b8b8b", "#8a8a8a", "#898989", "#888888", "#878787", "#868686", "#848484",
        "#838383", "#828282", "#818181", "#808080", "#7f7f7f", "#7e7e7e", "#7d7d7d", "#7c7c7c",
        "#7b7b7b", "#7a7a7a", "#787878", "#777777", "#767676", "#757575", "#747474", "#737373",
        "#727272", "#717171", "#707070", "#6f6f6f", "#6e6e6e", "#6d6d6d", "#6c6c6c", "#6b6b6b",
        "#6a6a6a", "#696969", "#686868", "#666666", "#656565", "#646464", "#636363", "#626262",
        "#616161", "#606060", "#5f5f5f", "#5e5e5e", "#5d5d5d", "#5c5c5c", "#5b5b5b", "#5a5a5a",
        "#595959", "#585858", "#575757", "#565656", "#555555", "#545454", "#535353", "#525252",
        "#505050", "#4f4f4f", "#4e4e4e", "#4c4c4c", "#4b4b4b", "#494949", "#484848", "#474747",
        "#454545", "#444444", "#424242", "#414141", "#404040", "#3e3e3e", "#3d3d3d", "#3b3b3b",
        "#3a3a3a", "#383838", "#373737", "#363636", "#343434", "#333333", "#313131", "#303030",
        "#2f2f2f", "#2d2d2d", "#2c2c2c", "#2a2a2a", "#292929", "#282828", "#262626", "#252525",
        "#232323", "#222222", "#212121", "#202020", "#1f1f1f", "#1e1e1e", "#1d1d1d", "#1b1b1b",
        "#1a1a1a", "#191919", "#181818", "#171717", "#161616", "#141414", "#131313", "#121212",
        "#111111", "#101010", "#0f0f0f", "#0d0d0d", "#0c0c0c", "#0b0b0b", "#0a0a0a", "#090909",
        "#080808", "#060606", "#050505", "#040404", "#030303", "#020202", "#010101", "#000000",
    ],
    "fire": [
        "#000000", "#040000", "#080000", "#0c0000", "#100000", "#140000", "#180000", "#1c0000",
        "#200000", "#240000", "#280000", "#2c0000", "#300000", "#340000", "#380000", "#3c0000",
        "#400000", "#440000", "#480000", "#4c0000", "#500000", "#540000", "#580000", "#5c0000",
        "#600000", "#640000", "#680000", "#6c0000", "#700000", "#740000", "#780000", "#7c0000",
        ...
        "#ff0000", "#ff0400", "#ff0900", "#ff0d00", "#ff1000", "#ff1400", "#ff1900", "#ff1d00",
        "#ff2000", "#ff2400", "#ff2900", "#ff2d00", "#ff3000", "#ff3400", "#ff3900", "#ff3d00",
        "#ff4100", "#ff4400", "#ff4900", "#ff4d00", "#ff5100", "#ff5400", "#ff5900", "#ff5d00",
        "#ff6100", "#ff6400", "#ff6900", "#ff6d00", "#ff7100", "#ff7400", "#ff7900", "#ff7d00",
        "#ff8100", "#ff8400", "#ff8900", "#ff8d00", "#ff9100", "#ff9400", "#ff9900", "#ff9d00",
        "#ffa100", "#ffa400", "#ffa900", "#ffad00", "#ffb100", "#ffb400", "#ffb900", "#ffbd00",
        "#ffc100", "#ffc400", "#ffc900", "#ffcd00", "#ffd100", "#ffd400", "#ffd900", "#ffdd00",
        "#ffe100", "#ffe400", "#ffe900", "#ffed00", "#fff100", "#fff400", "#fff900", "#fffd00",
        "#ffff01", "#ffff05", "#ffff09", "#ffff0d", "#ffff12", "#ffff16", "#ffff1a", "#ffff1e",
        "#ffff21", "#ffff25", "#ffff29", "#ffff2d", "#ffff32", "#ffff36", "#ffff3a", "#ffff3e",
        "#ffff41", "#ffff45", "#ffff49", "#ffff4d", "#ffff52", "#ffff56", "#ffff5a", "#ffff5e",
        "#ffff61", "#ffff65", "#ffff69", "#ffff6d", "#ffff72", "#ffff76", "#ffff7a", "#ffff7e",
        "#ffff82", "#ffff85", "#ffff89", "#ffff8d", "#ffff92", "#ffff96", "#ffff9a", "#ffff9e",
        "#ffffa2", "#ffffa5", "#ffffa9", "#ffffad", "#ffffb2", "#ffffb6", "#ffffba", "#ffffbe",
        "#ffffc2", "#ffffc5", "#ffffc9", "#ffffcd", "#ffffd2", "#ffffd6", "#ffffda", "#ffffde",
        "#ffffe2", "#ffffe5", "#ffffe9", "#ffffed", "#fffff2", "#fffff6", "#fffffa", "#fffffe",
